...
<script type="text/javascript" src="js/GenerateRupayUnmatchedTTUM.js"></script>
...
<form:form id="processform"  action="DownloadRupayUnmatchedTTUM.do" method="POST"  commandName="unmatchedTTUMBean" >
