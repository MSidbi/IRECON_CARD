...
<script type="text/javascript" src="js/GenerateVisaUnmatchedTTUM.js"></script>
...
<form:form id="processform"  action="DownloadVisaUnmatchedTTUM.do" method="POST"  commandName="unmatchedTTUMBean" >
