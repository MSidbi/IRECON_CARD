...
<script type="text/javascript" src="js/CashnetGLFileUpload1.js"></script>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form:form id="uploadform"  action="CashnetGLFileUpload1.do" method="POST" commandName="CompareSetupBean" enctype="multipart/form-data" >
                  <!--< div class="box-body">
			...
			<form:option value="MANUAL">MANUAL</form:option>
                    ...
                    <div class="form-group" id="trcategory" >
