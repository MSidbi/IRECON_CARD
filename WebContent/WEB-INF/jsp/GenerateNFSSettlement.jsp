...
/* $("#dailypicker").datepicker({dateFormat:"dd-M-yy", maxDate:0}); */
	...
	$("#dailypicker").datepicker({dateFormat:"yy/mm/dd", maxDate:0});
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Settlement Report</li>
		</ol>
	</section>
...
<form:form id="reportform"  action="DownloadSettreport.do" method="POST"  commandName="nfsSettlementBean" enctype="multipart/form-data" >
					...
					<div class="box-footer" style="text-align: center">
						<button type="button" class="btn btn-primary" onclick="processSettlement();">Process</button>
						<button type="button" class="btn btn-primary" onclick="downloadSettlement();">Download</button>
						<button type="button" class="btn btn-primary" onclick="RollBackSettlement();">RollBack</button>
