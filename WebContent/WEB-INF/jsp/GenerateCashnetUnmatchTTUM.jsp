...
<script type="text/javascript" src="js/GenerateCashnetUnmatchedTTUM.js"></script>
...
$(document).ready(function() {
   ...
   // $("#datepicker").datepicker({dateFormat:"dd-M-yy", maxDate:0});
    ...
    $("#localDate").datepicker({dateFormat:"yy/mm/dd", maxDate:0});
...
<form:form id="processform"  action="DownloadCashnetUnmatchedTTUM.do" method="POST"  commandName="unmatchedTTUMBean" >
						...
						<div class="form-group" id="acquirerOpt" style="display:none">
							...
							<form:select class="form-control" path="acqtypeOfTTUM" id="acqtypeOfTTUM">
								<option value="0">--Select --</option>
									...
									<option value="ACQFAILED">Failed</option>
							</form:select>
						</div>	
