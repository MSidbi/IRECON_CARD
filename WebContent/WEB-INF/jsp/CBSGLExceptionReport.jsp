...
<script type="text/javascript" src="js/DhanalaxmiSettlement.js"></script>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Gl Cbs Exception Report
			<!-- <small>Version 2.0</small> -->
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Gl Cbs Exception Report</li>
		</ol>
	</section>
...
<form:form id="reportform"  action="DownloadCBSGLExcepReport.do" method="POST"  commandName="nfsSettlementBean" enctype="multipart/form-data" >
					...
					<%-- <div class="form-group" style="display:${display}">
                     ...
                     <div class="form-group" id="Date">
							<label for="exampleInputPassword1">Date</label> <input
								...
								id="datepicker" placeholder="yyyy/mm/dd" title="yyyy/mm/dd" />
					</div>	
					
					<div class="box-footer" style="text-align: center">
						<!-- <button type="button" class="btn btn-primary" onclick="processEOD();">Process</button> -->
						<button type="button" class="btn btn-primary" onclick="downloadExcepReport();">Download</button>
