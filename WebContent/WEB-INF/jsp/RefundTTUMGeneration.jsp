...
<script type="text/javascript" src="js/RefundTTUMGeneration.js"></script>
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
<form:form id="reportform"  action="DownloadRefundTTUM.do" method="POST"  commandName="refundTTUMBean">
