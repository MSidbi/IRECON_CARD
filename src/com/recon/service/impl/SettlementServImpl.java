...
*/
	...
	public int Savechargeback(String microfilm, String ref_id,
			...
			throws Exception {
		// TODO Auto-generated method stub
		return settlementdao.Savechargeback(microfilm, ref_id, settlement_amount, settlement_currency, txn_amount, txn_currency, reason, documentation,  remarks);
	}
	...
	public int SaveGl(String closingbal, String settlementid, String diff,
			...
			String surch_total, String val2, String autorev_total, String val3,
			String lpcasetotal, String finaltotal, String dateval)
			throws Exception {
		// TODO Auto-generated method stub
		return settlementdao.SaveGl(closingbal, settlementid, diff, cbs_unrecon, switch_unrecon, nobase2, settlementmatch, nxtdate, surcharge1, settlementTotal, lpcase2, val1, surch_total, val2, autorev_total, val3, lpcasetotal, finaltotal, dateval);
	}
