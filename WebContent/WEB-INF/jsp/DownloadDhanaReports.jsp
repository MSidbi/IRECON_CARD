...
<script type="text/javascript" src="js/DownloadDhanaReports.js"></script>
          ...
          <div class="col-md-4"></div>
            ...
            <div class="col-md-4">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form:form name="reportform" id="reportform" action="DownloadDhanaReports.do" method="POST" commandName="SettlementBean" >
                <form role="form">
