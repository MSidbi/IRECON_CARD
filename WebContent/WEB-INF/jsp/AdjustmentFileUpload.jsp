...
<script type="text/javascript" src="js/AdjustmentUpload.js"></script>
...
<form:form id="uploadform"  action="AdjustmentFileUpload.do" method="POST"  commandName="nfsSettlementBean" enctype="multipart/form-data" >
                    ...
                    <div class="form-group" style="display:${display}">
                     ...
                     <div class="form-group" id="Date" tyle="display:${display}" >
					...
					<div class="box-footer" style="text-align: center">
						...
						<a onclick="AdjustmentRollback();" class="btn btn-primary">Rollback</a>
					</div>
